...
class BatteryWidget extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final batteryColor = battery.percentage > 50
        ? AppColors.success
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Expanded(
              child: Center(
                child: _BatteryArc(percentage: 78, isCharging: true),
              ),
            ),
            Center(
              child: Row(
                ...
                children: [
                  ...
                  Text('${battery.percentage.toInt()}%', style: TextStyle(
                    fontSize: 32, fontWeight: FontWeight.w700, color: batteryColor,
                  )),
                ],
...
class _BatteryArc extends StatelessWidget {
  ...
  const _BatteryArc({required this.percentage, required this.isCharging});
